    ...
    return (
        ...
        <Row>
          <div className="d-flex flex-column mt-2">
            <div className="filter-title d-flex justify-content-start">Category</div>
          ...
          <div className="d-flex flex-column mt-2">
            <div className="filter-title mt-3 d-flex justify-content-start">Brand</div>
            <div className="d-flex mt-3">
              <input type="checkbox" value="" />
              <div className="filter-sub me-2 ">All</div>
            </div>
          ...
          <div className="filter-title my-3 d-flex justify-content-start">Price</div>
