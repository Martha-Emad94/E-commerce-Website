...
const Footer = () => {
    return (
        <div className="Footer mt-4 pt-2">
            ...
            <img width="22px" height="22px" src={phone}/>01277784569
            </div>
            <div style={{cursor:"pointer"}}>
            <img width="22px" height="22px" src={facebook}/>
            </div>
            <div style={{cursor:"pointer"}}>
            <img width="22px" height="22px" src={instagram}/>
            </div>
            <div style={{cursor:"pointer"}}>
            <img width="22px" height="22px" src={twitter}/>
            </div>
            </Col>
            </Row>
            </Container>
